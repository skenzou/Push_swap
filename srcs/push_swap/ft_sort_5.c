...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/06/15 13:28:42 by midrissi          #+#    #+#             */
/*   Updated: 2019/06/15 15:09:37 by midrissi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

static void		ft_sort_5_b(t_list **stack_a, t_list **stack_b, char dest)
{
	int i;
...
void			ft_sort_5(t_list **stack_a, t_list **stack_b, char dest)
{
	...
	if (dest == STACK_A)
	{
		...
		ft_sort_5_b(stack_a, stack_b, dest);
}
